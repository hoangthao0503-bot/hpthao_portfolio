...
const portfolioData = {
    ...
    professional: [
        {
            title: "Vietnam Energy Sector Analysis",
            description: "Comprehensive data analysis and visualization of the energy sector in Vietnam, highlighting trends and insights.",
            tags: ["Data Analysis", "HTML", "Visualization"],
            githubLink: "https://github.com/hoangthao0503-bot/Vietnam-Energy-Sector-Analysis"
        },
        {
            title: "Stock Analysis Web",
            description: "A comprehensive web application designed for robust stock market analysis, featuring dynamic data visualization and real-time tracking.",
            tags: ["TypeScript", "Web Development", "Finance"],
            githubLink: "https://github.com/hoangthao0503-bot/stock-analysis-web"
        },
        {
        ...
        {
            title: "VN30 Analysis",
            description: "Data analysis and tracking tools focused on the VN30 index in the Vietnamese stock market.",
            tags: ["PowerShell", "Data Analytics"],
            githubLink: "https://github.com/hoangthao0503-bot/Vn30"
        }
    ],
    entrepreneurial: []
};
